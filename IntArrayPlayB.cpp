...
int findInsertPosition (int array[], int numElements, int insertval);
...
// @param: int array[] is an array of integers
// @param: int& numberElements has the number of Elements in the array
// @returns void.
...
//in an ordered array.
// findInsertPosition - looks thru an ordered array to find the position of
// the value to insert. All values before are less than the target value.
// The value after should be greater than the target value. [No need to sort]
...
// insertElement - insert  the element of the given index to  the given array.
// @param: int array[] is an unordered array of integers
// @param: int& numberElements
...
int main()
{
// The numArray can be partially filled, we use variable numArrayElems
...
cin>> insertVal;
int insertPosition= findInsertPosition ( numArray, numArrayElems, insertVal);
insertElement (numArray,numArrayElems, insertPosition, insertVal);
displayArray ( numArray, numArrayElems);
...
int deleteVal;
cin>> deleteVal;
int removePosition= searchElement(numArray, numArrayElems, deleteVal);
